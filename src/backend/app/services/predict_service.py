...
class PredictService:
    ...
    def get_all_predicitons(self) -> List[Prediction]:
...
class PredictServiceSingleton:
    ...
    def initialize(cls, predict_repo: PredictionsRepository):
        if cls._instance is None:
            cls._instance = PredictService(predict_repo)

    @classmethod
    def get_instance(cls) -> PredictService:
        if cls._instance is None:
            raise Exception("ModelServiceSingleton is not initialized. Call initialize() first.")
