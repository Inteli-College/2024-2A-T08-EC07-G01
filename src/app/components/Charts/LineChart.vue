...
const data2 = await fetchChartData(true);
...
<template>
  <div class="flex flex-col items-center w-full">
    ...
    <div class="mb-4 w-2/3">
      <label for="dataSelect" class="block mb-1 font-medium text-gray-700 text-center">Selecione o Conjunto de
        Dados</label>
      <select id="dataSelect" @change="updateData"
