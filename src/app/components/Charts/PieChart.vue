...
import { ref } from 'vue'
import { getPieChart, type TestPieChart } from './PieData'
...
const data = getPieChart() as TestPieChart[]

// Variável para controlar o centro do gráfico (remover círculo e número do centro)
