<template>
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      ...
      <!-- Tela de carro sem falha prevista -->
      <div v-if="knrStatus === 'sem-falha'" class="w-full max-w-4xl p-8 bg-white border-2 border-green-400 rounded-lg shadow-lg">
        <div class="flex items-center gap-4 mb-6">
          <svg id="Layer_1" viewBox="0 0 612 792" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path fill="#41AD49" d="M562,396c0-141.4-114.6-256-256-256S50,254.6,50,396s114.6,256,256,256S562,537.4,562,396L562,396z
        ...
        <p class="text-center text-gray-700 text-xl font-medium mb-6">KNR: 7777</p>
        <p class="text-center text-gray-500 mb-4">Tipo de Falha Prevista</p>
        <div class="grid grid-cols-9 gap-4 mt-2">
          <div class="border border-gray-300 px-6 text-center">Tipo 1</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 2</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 3</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 4</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 5</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 6</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 7</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 8</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 9</div>
        </div>
      </div>
  
      <!-- Tela de carro com falha prevista -->
      <div v-if="knrStatus === 'com-falha'" class="w-full max-w-4xl p-8 bg-white border-2 border-red-400 rounded-lg shadow-lg">
        <div class="flex items-center gap-4 mb-6">

          <svg id="Layer_1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <circle fill="#C93636" cx="64" cy="64" r="64"/>
            <path fill="#FFFFFF" d="M100.3,90.4L73.9,64l26.3-26.4c0.4-0.4,0.4-1,0-1.4l-8.5-8.5c-0.4-0.4-1-0.4-1.4,0L64,54.1L37.7,27.8
            c-0.4-0.4-1-0.4-1.4,0l-8.5,8.5c-0.4,0.4-0.4,1,0,1.4L54,64L27.7,90.3c-0.4,0.4-0.4,1,0,1.4l8.5,8.5c0.4,0.4,1.1,0.4,1.4,0L64,73.9
        ...
        <p class="text-center text-gray-700 text-xl font-medium mb-6">KNR: 2023-2056234</p>
        <p class="text-center text-gray-500 mb-4">Tipo de Falha Prevista</p>
        <div class="grid grid-cols-9 gap-4 mt-2">
          <div class="border border-gray-300 px-6 text-center">Tipo 1</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 2</div>
          ...
          <div class="border border-gray-300 px-6 text-center">Tipo 5</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 6</div>
          <div class="bg-red-400 text-white border border-red-400 px-6 text-center">Tipo 7</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 8</div>
          <div class="border border-gray-300 px-6 text-center">Tipo 9</div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      verificarKNR() {
        if (this.knr === '1') {
          this.knrStatus = 'sem-falha';
        } else if (this.knr === '2') {
          this.knrStatus = 'com-falha';
        } else {
          this.knrStatus = null;
          alert('KNR inválido!');
        }
