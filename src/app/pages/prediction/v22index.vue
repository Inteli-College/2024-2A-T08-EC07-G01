...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-50">
    ...
    <div v-if="!knrStatus" class="relative w-64 mb-6">
      <input type="text" placeholder="Digite o KNR" v-model="knr" @keyup.enter="verificarKNR"
    ...
    <div v-if="knrStatus === 'sem-falha'"
      class="w-full max-w-4xl p-8 bg-white border-2 border-green-400 rounded-lg shadow-lg">
    ...
    <div v-if="knrStatus === 'com-falha'"
      class="w-full max-w-4xl p-8 bg-white border-2 border-red-400 rounded-lg shadow-lg">
      <div class="flex items-center gap-4 mb-6">
      ...
      <div class="grid grid-cols-9 gap-4 mt-2">
        <div v-for="i in 9" :key="i"
          :class="['border', 'px-6', 'text-center', failureType === 'Tipo ' + i ? 'bg-red-400 text-white border-red-400' : 'border-gray-300']">
          Tipo {{ i }}
        </div>
      </div>
      <!-- Botão de Voltar -->
