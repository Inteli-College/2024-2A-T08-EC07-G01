...
Para ler um texto complementar da explicação, acessar seção [Viabilidade Técnica](../Requisitos%20de%20Viabilidade%20Técnica/Viabilidade%20do%20Projeto.md), bem como o notebook python na pasta `src`.
