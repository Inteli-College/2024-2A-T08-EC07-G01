...
### **3.2** **Obtenção da Chave Privada `.pem`:**
   ...
   :::info
   Neste cenário, a chave SSH será disponibilizada exclusivamente para os membros do projeto. Para acessos futuros, será necessário criar uma nova instância EC2 e seguir os passos detalhados na seção **A ADICIONAR**.
   :::
