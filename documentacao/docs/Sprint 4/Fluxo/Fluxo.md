...
#### **1.1.1.1** Recebimento e coleta de dados
...
#### **1.1.1.2** Execução do Script de Treinamento
...
#### **1.1.1.3** Testes em Background e Armazenamento de Resultados
...
Ao final do processo, o modelo treinado é disponibilizado para uso na aplicação, permitindo a realização de previsões com base nos dados fornecidos. O modelo é integrado ao sistema, permitindo que os usuários façam consultas e recebam previsões precisas e atualizadas.

### **1.1.2** Fluxo de predição
...
#### **1.1.2.1** Recepção e Armazenamento de Dados
...
#### **1.1.2.3** Armazenamento dos Resultados

Após a execução do script de predição, os resultados gerados são salvos no MongoDB, garantindo que as predições possam ser acessadas e analisadas posteriormente. Esses resultados são armazenados de forma eficiente, utilizando o **GridFS**, especialmente se envolverem grandes quantidades de dados ou arquivos complexos.

### **1.1.3** Fluxo de Consulta do KNR
...
#### **1.1.3.1** Solicitação de Consulta do KNR pelo FrontEnd
...
#### **1.1.3.2** Consulta e Recuperação da Predição pelo BackEnd
...
#### **1.1.3.3** Retorno dos Resultados ao FrontEnd
...
### **1.1.4** Fluxo de Análise dos Modelos
...
#### **1.1.4.1** Solicitação de Análise pelo FrontEnd
...
#### **1.1.4.2** Coleta de Dados e Comparação pelo BackEnd

Assim que o BackEnd recebe a solicitação, ele inicia a coleta dos dados de testes recentes armazenados no MongoDB. Esses dados podem incluir métricas de desempenho, resultados de predições anteriores e outras informações relevantes para a análise dos modelos. O BackEnd então entra em um loop de análise, onde diferentes modelos são comparados, e seus resultados são avaliados com base nos dados coletados.

#### **1.1.4.3** Envio das Análises para o FrontEnd
...
### **1.1.5** Fluxo de Escolha do Modelo
...
#### **1.1.5.1** Solicitação de Comparação de Modelos pelo FrontEnd
...
#### **1.1.5.2** Consulta e Comparação de Modelos pelo BackEnd
...
#### **1.1.5.3** Exibição dos Resultados e Atualização do Modelo Ativo
